...
public class JsonController
{
  ...
  public Object userLogin(@RequestBody String ps)
  {
    ...
    String nativeyzm = (String)this.request.getSession().getAttribute("sRand");
    ...
    this.request.getSession().setAttribute("userid", Integer.valueOf(res.getId()));
  ...
  public Object userRegister(@RequestBody String ps) {
    ...
    User user = new UserDaoImpl().findUserByUserName(
      (String)map
      .get("username"));
    if (user != null) {
      return Integer.valueOf(1);
  ...
  public Object changePassword(@RequestBody String ps) {
    ...
    int id = 0;
    try {
      id = ((Integer)this.request.getSession().getAttribute("userid")).intValue();
    }
  ...
  public Object lengre(@RequestBody String ps) {
    ...
    return StringList.subList(0, zongqishu);
  }
  ...
  public Object manageupdateuser(@RequestBody String ps)
  {
    ...
    uservip.setType(type);
    try {
      long fufeiriqi = new Long((String)map.get("fufeiriqi")).longValue();
      long daoqiriqi = new Long((String)map.get("daoqiriqi")).longValue();
